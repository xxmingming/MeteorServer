...
CConnection * CDatabase::CreateConnection(const char *pDSN, const char *pID, const char *pPassword )
{
...
bool CConnection::Init( SQLHENV hEnv, const char *pDSN, const char *pID, const char *pPassword )
{
	int nResult;
