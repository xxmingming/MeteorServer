...
public:
	...
	CConnection * CreateConnection(const char *pDSN, const char *pID, const char *pPassword );
...
private:
	...
	bool Init( SQLHENV hEnv, const char *pDSN, const char *pID, const char *pPassword );
	void Uninit();
